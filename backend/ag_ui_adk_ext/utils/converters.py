# ag_ui_adk_ext/utils/converters.py

"""Conversion utilities between AG-UI and ADK formats.

This module provides utilities for converting between AG-UI protocol messages
and Google ADK events/content formats.
"""
